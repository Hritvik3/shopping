...
<div class="" ng-app="ShoppingApp" ng-controller="ProductController as pCtrl" >
				...
				<div class="col-md-12">
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item">
								<img class="slide-image" src="${images}/badminton2.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/Table-Tennis.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/football2.jpg"
									alt="">
							</div>
						</div>
